...
standlist = []
standlist.append({'teamId': int(1), 'teamName': 'Beşiktaş','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(58), 'change': int(1)})
standlist.append({'teamId': int(2), 'teamName': 'Bursaspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(55), 'change': int(-1)})
standlist.append({'teamId': int(3), 'teamName': 'Eskişehirspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(8), 'points':int(46), 'change': int(2)})
standlist.append({'teamId': int(4), 'teamName': 'Fenerbahçe','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(61), 'change': int(3)})
standlist.append({'teamId': int(5), 'teamName': 'Galatasaray','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(71), 'change': int(-4)})
standlist.append({'teamId': int(6), 'teamName': 'Gaziantepspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(-7), 'points':int(46), 'change': int(0)})
standlist.append({'teamId': int(7), 'teamName': 'Gençlerbirliği','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(45), 'change': int(1)})
standlist.append({'teamId': int(8), 'teamName': 'İstanbul BŞB','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(36), 'change': int(1)})
standlist.append({'teamId': int(9), 'teamName': 'KDÇ Karabük','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(40), 'change': int(1)})
standlist.append({'teamId': int(12), 'teamName': 'Antalyaspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(47), 'change': int(1)})
standlist.append({'teamId': int(11), 'teamName': 'Akhisar Bel.','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(42), 'change': int(1)})
standlist.append({'teamId': int(17), 'teamName': 'Sivasspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(44), 'change': int(1)})
standlist.append({'teamId': int(14), 'teamName': 'S.B. Elazığspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(43), 'change': int(1)})
standlist.append({'teamId': int(15), 'teamName': 'Orduspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(29), 'change': int(1)})
standlist.append({'teamId': int(13), 'teamName': 'Mersin İY','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(22), 'change': int(1)})
standlist.append({'teamId': int(18), 'teamName': 'Trabzonspor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(-1), 'points':int(46), 'change': int(1)})
standlist.append({'teamId': int(16), 'teamName': 'Kasımpaşa','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(50), 'change': int(1)})
standlist.append({'teamId': int(10), 'teamName': 'Kayserispor','played':int(34), 'win':int(16), 'draw':int(10), 'lose':int(8), 'score':randint(18,71), 'conceded' : int(49), 'average':int(14), 'points':int(52), 'change': int(1)})
...
def team(request, num):
    ...
    return render_to_response('statsteam.html', {'s_list': s,'team_list': teamList, 'standing_list':standlist, 'team_selected': int(num), 'player_list':playerList, 'weeklist': weekList,'best_eleven_list':bestList})
...
def playerx(request, num, player_id):
    ...
    return render_to_response('statsplayer.html', {'p_id': int(player_id), 'team_selected': int(num), 'team_list': teamList, 'standing_list': standlist, 'player_list':playerList, "best_eleven_list":bestList, 'weeklist': weekList})
...
def player3(request, num):
    ...
    return render_to_response('playerselection.html', { 'team_selected': int(num), 'team_list': teamList, 'standing_list': standlist, 'player_list':playerList, "best_eleven_list":bestList, 'weeklist': weekList})

def before(request):

    return render_to_response('virtual_stadium_before_match.html', {'weeklist': weekList})
def center(request):
    return render_to_response('virtual_stadium.html', {'weeklist': weekList})
def summary(request):
