...
def team(request, num):
    ...
    return render_to_response('sc_team.html', {'fixture':fixtureDict,
                                                 'try_list':teamDict,
                                                 'details':detailDict,
                                                 'players':playerDict,
                                                 'standing_list':standingDict,
...
def teamselect(request):
    ...
    standingDict = []
    data = {"leagueId":LEAGUE_ID,"seasonId":SEASON_ID,"type":0}
    ...
    return render_to_response('sc_teamselect.html',{'standing_list':standingDict,
                                                    'weeklist':weekList,
                                                    'try_list':teamDict} )
